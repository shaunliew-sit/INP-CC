...
def get_args_parser():
    ...
    parser.add_argument('--semantic_units_file', default="", type=str,
                        help='whether to use prompt hint in the text encoder')
    # ScenePrompts
    parser.add_argument('--text_scene_num', default=0, type=int, help='number of scene prompts')
    parser.add_argument('--img_scene_num', default=0, type=int, help='number of scene prompts')
    parser.add_argument('--VPT_length', default=0, type=int, help='number of scene prompts')
    parser.add_argument('--VPT_low_rank', default=False, type=lambda x: (str(x).lower() == 'true'))
    parser.add_argument('--low_rank', default=True, type=lambda x: (str(x).lower() == 'true'))
    parser.add_argument('--pattern_num', default=2, type=int, help='number of topk patterns')
    ## Region Prompt
    parser.add_argument('--region_prompt_dim', default=0, type=int, help='dimension of region prompt')
    # additional_hoi_num during training
    parser.add_argument('--add_hoi_strategy', default="hard", type=str, choices=["random", "hard", "easy", "half"])
    parser.add_argument('--additional_hoi_num', default=0, type=int, help='number of additional hoi prompts')
    parser.add_argument('--cluster_assignmen_file', default="", type=str, help='path to the cluster assignment file')
    parser.add_argument('--instruction_embedding_file', default="", type=str,)
    # * Text
